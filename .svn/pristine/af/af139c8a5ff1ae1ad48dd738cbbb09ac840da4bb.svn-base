 ...
 * @author lh
 */
public class HeiLongJiangCustomer extends BidCustomer {

    public HeiLongJiangCustomer(RedisQueue queue) throws Exception {
        super(queue);
    ...
    public void process(String jsonStr) {
        try {
            ...
            String info = doc.select("#contentdiv").outerHtml();
            Save(json.getTitle(), json.getPubtime(), info, json.getUrl(), "黑龙江省公共资源交易中心");
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        try {
            ...
            HeiLongJiangCustomer b = new HeiLongJiangCustomer(queue);
