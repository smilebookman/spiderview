 ...
 * @author lh
 */
public class HeNanCustomer extends BidCustomer {

    public HeNanCustomer(RedisQueue queue) throws Exception {
        super(queue);
    ...
    public void process(String jsonStr) {
        try {
            ...
            String info = doc.select("div.ewb-left-bd").outerHtml();
            Save(json.getTitle(), json.getPubtime(), info, json.getUrl(), "河南省公共资源交易中心");
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        try {
            ...
            HeNanCustomer b = new HeNanCustomer(queue);
