 ...
 * @author cxyue
 */
public class ShanDongCustomer extends BidCustomer {

    public ShanDongCustomer(RedisQueue queue) throws Exception {
        super(queue);
    }
    ...
    public void process(String jsonStr) {
        try {
            ...
            String info = doc.select("body > div.content > div.div-content > div.div-article2").outerHtml();
            Save(json.getTitle(), json.getPubtime(), info, json.getUrl(), "山东省公共资源交易网");
            Thread.sleep(1000);
        } catch (Exception ex) {
            Logger.getLogger(ShanDongCustomer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            ShanDongCustomer b = new ShanDongCustomer(queue);
